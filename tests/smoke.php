...
$results[] = flus_run_test('caja mantiene un unico resumen operativo de cobro', function (): void {
    ...
    flus_assert_contains('data-caja-summary-action', $cajaPhp);
    flus_assert_contains('id="denomChips" class="denom-chips is-hidden"', $cajaPhp);
    flus_assert_contains('document.querySelectorAll("[data-caja-summary-action]")', $cajaJs);
    flus_assert_contains('event.stopPropagation();', $cajaJs);
