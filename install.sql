...
DROP TABLE IF EXISTS `cloud_command_receipts`;
CREATE TABLE `cloud_command_receipts` (
...
CREATE TABLE `movimientos_stock` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `ux_movimientos_stock_request_uid` (`request_uid`),
