...
- `install.sql` y migraciones `037_venta_items_ajustes_precio.sql` / `038_venta_items_ajustes_redondeo.sql` / `039_venta_pagos_mp_metadata.sql` quedan alineados para instalacion limpia y upgrade.
