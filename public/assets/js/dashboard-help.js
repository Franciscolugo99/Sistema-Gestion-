...
(function () {
  ...
  const TOUR_STEPS = [
    {
      ...
      content:
        'Aquí ves un resumen rápido: ventas totales, facturación, ticket promedio y unidades vendidas. Haz clic en el "?" para más detalles.',
    },
    {
      element: ".dash-presets",
      title: "Filtros rápidos",
      content:
        "Usa estos botones para cambiar rápidamente el período: hoy, última semana, mes, etc.",
    },
    {
      element: ".cierre-caja-section",
      title: "Cierre de Caja",
      content:
        "Resumen del día actual: cuánto vendiste, cuánto en efectivo vs otros medios. Ideal para el arqueo.",
    },
    {
      element: ".insights-container",
      title: "Insights automáticos",
      content:
        "El sistema analiza tus datos y te da recomendaciones accionables.",
    },
    {
      element: ".dash-export-dd",
      title: "Exportar datos",
      content:
        "Descarga reportes en CSV para análisis más detallados o para compartir.",
    },
  ];
  ...
  function initTooltips() {
    ...
    document.addEventListener("click", (e) => {
      if (
        activeTooltip &&
        !e.target.closest(".kpi-help") &&
        !e.target.closest(".kpi-tooltip")
      ) {
        hideTooltip();
      }
    });
