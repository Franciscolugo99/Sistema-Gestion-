...
>
    ...
    <div class="session-card active session-card-static">
        ...
        <div class="session-actions">
            ...
            <form method="post" class="inv-inline-form js-inv-confirm-form" data-confirm-title="Cerrar sesi�n" data-confirm-message="Luego podr�s aplicar ajustes desde Resumen." data-confirm-icon="warning" data-confirm-text="Cerrar sesi�n" data-cancel-text="Cancelar">
    ...
    <?php if (($currentSession['estado'] ?? '') === 'ABIERTA'): ?>
        <div class="inv-actions-panel">
            ...
            <div class="inv-actions-row">
                ...
                <form method="post" class="inv-inline-form js-inv-confirm-form" data-confirm-title="Cerrar sesi�n" data-confirm-message="Esto bloquea nuevos conteos. Despu�s podr�s aplicar ajustes desde Resumen." data-confirm-icon="warning" data-confirm-text="Cerrar sesi�n" data-cancel-text="Cancelar">
                    <input type="hidden" name="csrf_token" value="<?= h($_SESSION['csrf_token']) ?>">
                    <input type="hidden" name="accion" value="cerrar_sesion">
                    <input type="hidden" name="motivo" value="Cerrado para aplicar ajustes">
    ...
    <?php elseif (($currentSession['estado'] ?? '') === 'CERRADA'): ?>
        <div class="inv-actions-panel">
            <div class="inv-actions-row">
                ...
                <form method="post" class="inv-inline-form js-inv-confirm-form" data-confirm-title="Aplicar ajustes de stock" data-confirm-message="Esta acci�n no se puede deshacer. Se ajustar�n <?= (int)$resumen['productos_con_diferencia'] ?> productos." data-confirm-icon="warning" data-confirm-text="Aplicar ajustes" data-confirm-color="#0f766e" data-cancel-text="Cancelar">
                    <input type="hidden" name="csrf_token" value="<?= h($_SESSION['csrf_token']) ?>">
