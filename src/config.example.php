...
define('FLUS_CLOUD_SYNC_HEARTBEAT_INTERVAL_SEC', (int)flus_env('FLUS_CLOUD_SYNC_HEARTBEAT_INTERVAL_SEC', '300'));
define('FLUS_CLOUD_SYNC_STOCK_SNAPSHOT_INTERVAL_SEC', (int)flus_env('FLUS_CLOUD_SYNC_STOCK_SNAPSHOT_INTERVAL_SEC', '900'));
